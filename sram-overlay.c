...
__attribute__ ((section (".sram_overlay")))bool overlay_FLASH_RebootToBootloader(void)
{
...
__attribute__ ((section (".sram_overlay"))) bool overlay_FLASH_IsBusy(void)
{
	return (FLASH_ST & FLASH_ST_BUSY_MASK) != FLASH_ST_BUSY_BITS_READY;
}

__attribute__ ((section (".sram_overlay"))) bool overlay_FLASH_IsInitComplete(void)
{
	return (FLASH_ST & FLASH_ST_INIT_BUSY_MASK) == FLASH_ST_INIT_BUSY_BITS_COMPLETE;
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_Start(void)
{
	overlay_FLASH_Unlock();
	FLASH_START |= FLASH_START_START_BITS_START;
}

__attribute__ ((section (".sram_overlay")))  void overlay_FLASH_Init(FLASH_READ_MODE ReadMode)
{
...
__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_MaskLock(void)
{
	FLASH_MASK = (FLASH_MASK & ~FLASH_MASK_LOCK_MASK) | FLASH_MASK_LOCK_BITS_SET;
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetMaskSel(FLASH_MASK_SELECTION Mask)
{
	FLASH_MASK = (FLASH_MASK & ~FLASH_MASK_SEL_MASK) | ((Mask << FLASH_MASK_SEL_SHIFT) & FLASH_MASK_SEL_MASK);
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_MaskUnlock(void)
{
	FLASH_MASK = (FLASH_MASK & ~FLASH_MASK_LOCK_MASK) | FLASH_MASK_LOCK_BITS_NOT_SET;
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_Lock(void)
{
	FLASH_LOCK = FLASH_LOCK_LOCK_BITS_LOCK;
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_Unlock(void)
{
	FLASH_UNLOCK = FLASH_UNLOCK_UNLOCK_BITS_UNLOCK;
}

__attribute__ ((section (".sram_overlay"))) uint32_t overlay_FLASH_ReadByAHB(uint32_t Offset)
{
	return *(volatile uint32_t *)(Offset & ~3U);
}

__attribute__ ((section (".sram_overlay"))) uint32_t overlay_FLASH_ReadByAPB(uint32_t Offset)
{
	uint32_t Data;
...
__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetArea(FLASH_AREA Area)
{
	FLASH_CFG = (FLASH_CFG & ~FLASH_CFG_NVR_SEL_MASK) | ((Area << FLASH_CFG_NVR_SEL_SHIFT) & FLASH_CFG_NVR_SEL_MASK);
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetReadMode(FLASH_READ_MODE Mode)
{
...
__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetEraseTime(void)
{
	FLASH_ERASETIME = ((overlay_FLASH_ClockMultiplier & 0xFFFFU) * 0x1A00000U) + (overlay_FLASH_ClockMultiplier * 3600U);
}

__attribute__ ((section (".sram_overlay")))  void overlay_FLASH_WakeFromDeepSleep(void)
{
...
__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetMode(FLASH_MODE Mode)
{
	FLASH_CFG = (FLASH_CFG & ~FLASH_CFG_MODE_MASK) | ((Mode << FLASH_CFG_MODE_SHIFT) & FLASH_CFG_MODE_MASK);
}

__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_SetProgramTime(void)
{
	FLASH_PROGTIME = overlay_FLASH_ClockMultiplier * 45074;
}

__attribute__ ((section (".sram_overlay"))) void overlay_SystemReset(void)
{
...
__attribute__ ((section (".sram_overlay"))) uint32_t overlay_FLASH_ReadNvrWord(uint32_t Offset)
{
	uint32_t Data;
...
__attribute__ ((section (".sram_overlay"))) void overlay_FLASH_ConfigureTrimValues(void)
{
	uint32_t Data;
